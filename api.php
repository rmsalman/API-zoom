...
if(isset($_POST['email']) && !empty($_POST['email'])){
	...
	// function sendRequest($calledFunction, $data){
		...
		$request_url = $api_url.'user/create';
...
echo '<br><br>';
echo '<h1 style="text-align:center;">Invitation email sent at: ' . $_POST['email'] . ' <br><a href="index.html">Go Back</a></h1>';


}
else {
	echo 'Email plz <a href="index.html">Go Back</a>';
}
?> 